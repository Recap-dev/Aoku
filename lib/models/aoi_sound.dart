...
List<AoiSound> soundsMaster = [
  AoiSound(
    ...
    length: const Duration(hours: 1, minutes: 4, seconds: 0),
    city: 'Toyota',
    province: 'Aichi',
  ...
  AoiSound(
    ...
    location: const LatLng(35.135616330301005, 137.31655937710295),
    length: const Duration(hours: 0, minutes: 27, seconds: 36),
    city: 'Toyota',
    province: 'Aichi',
  ...
  AoiSound(
    ...
    location: const LatLng(35.135616330301005, 137.31655937710295),
    length: const Duration(hours: 0, minutes: 15, seconds: 7),
    city: 'Toyota',
    province: 'Aichi',
  ...
  AoiSound(
    ...
    location: const LatLng(35.135616330301005, 137.31655937710295),
    length: const Duration(hours: 0, minutes: 6, seconds: 5),
    city: 'Toyota',
    province: 'Aichi',
  ...
  AoiSound(
    ...
    location: const LatLng(35.135616330301005, 137.31655937710295),
    length: const Duration(hours: 0, minutes: 13, seconds: 9),
    city: 'Toyota',
    province: 'Aichi',
    time: const TimeOfDay(hour: 7, minute: 11),
  ),
  AoiSound(
    ...
    location: const LatLng(35.135616330301005, 137.31655937710295),
    length: const Duration(hours: 0, minutes: 8, seconds: 10),
    city: 'Toyota',
    province: 'Aichi',
  ...
  AoiSound(
    ...
    location: const LatLng(35.135616330301005, 137.31655937710295),
    length: const Duration(hours: 0, minutes: 3, seconds: 44),
    city: 'Toyota',
    province: 'Aichi',
  ...
  AoiSound(
    ...
    length: const Duration(hours: 0, minutes: 5, seconds: 44),
    city: 'Osaka',
    province: 'Osaka',
  ...
  AoiSound(
    ...
    length: const Duration(hours: 0, minutes: 14, seconds: 35),
    city: 'Nagoya',
    province: 'Aichi',
  ...
  AoiSound(
    ...
    length: const Duration(hours: 0, minutes: 4, seconds: 55),
    city: 'Shinagawa',
    province: 'Tokyo',
